...
param_dict = {1:[0.16613755734048244,0.0005173666621570022],6:[1.8163628805762924,1.0953373541809297e-05],7:[1.7822807717481028,9.051347402810559e-05],8:[0.12474987882895518,3.5087348406133207e-07]}
...
for specie in [1, 6, 7,8]:
    ...
    kernel = RBF(param_dict[specie][0])
    
    K_precompute = kernel(Xtrain_full)
    #K = self._get_kernel(X, self.X_fit_)
    K_test_precompute = kernel(Xtest, Xtrain_full)
