...
#N_layer, lr, decay
NN_dict={1:[512,1.9355107329554695e-05,6.711552567464942e-05, nn.Softplus],
         6:[256,0.00026058145025235826,1e-06, nn.Tanh],
         7:[16,0.0004901512427574183,0.112315904, nn.Softplus],
         8:[512,7.789736230259994e-05,0.0080,nn.Tanh]}
...
for specie in [1,6,7,8]:
    ...
    for model_no in range(16):
        ...
        model = NeuralNetwork(l1=NN_dict[specie][0],layer=NN_dict[specie][3]).to(device)
